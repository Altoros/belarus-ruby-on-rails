Feature: Social Network authorization without shared email
  ...
  don't allow access to this information
    ...
    Scenario Outline: A user without shared email signs in with Facebook and enter email in application
    ...
    @omniauth_test_without_email @omniauth_test_after
    Scenario Outline: A user without shared email signs in with Facebook and enter reserved email
      Given I follow "Sign in with <provider>"
