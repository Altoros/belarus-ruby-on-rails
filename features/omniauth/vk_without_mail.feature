Feature: Vkontakte authorization without shared email
  ...
  don't allow access to this information
    ...
    Scenario: A user without shared email signs in with Vkontakte and enter email in application
    ...
    @omniauth_test_without_email @omniauth_test_after
    Scenario: A user without shared email signs in with Vkontakte and enter reserved email
