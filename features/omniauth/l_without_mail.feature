Feature: Linked In authorization without shared email
  ...
  don't allow access to this information
    ...
    Scenario: A user without shared email signs in with Linked In and enter email in application
    ...
    @omniauth_test_without_email @omniauth_test_after
    Scenario: A user without shared email signs in with Linked In and enter reserved email
