Feature: Twitter authorization without shared email
  ...
  don't allow access to this information
    ...
    Scenario: A user without shared email signs in with Twitter and enter email in application
    ...
    @omniauth_test_without_email @omniauth_test_after
    Scenario: A user without shared email signs in with Twitter and enter reserved email
